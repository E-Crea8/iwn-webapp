            ...
            <div class="card">
              <div class="card-body">
               ...
               ?>
                ...
                <div class="row">
                    <div class="form-group col-12">
                      <label for="equipment_details">Type of Installation</label>
                      <input id="equipmentDetails" type="text" class="form-control" name="equipment_details" autofocus required>
                    </div>
                  </div>
