...
<head>
  ...
  <title>IWN App - Manage Work Order Record</title>
...
<script type="text/javascript">
    ...
    <script>  
 $(document).ready(function(){  
      $('#workOrderFormData').DataTable();  
 });  
 </script>  



<!-- Delete Work Order Record Sweet Alert -->
<script>
 $(document).ready(function(){
  
  // readOrderForms* it will load products when document loads */
  
  $(document).on('click', '#delete-work-order-form', function(e){
  ...
  swal.fire({
   ...
   preConfirm: function() {
     return new Promise(function(resolve) {
        ...
        $.ajax({
        url: 'delete-work-order-form.php',
        type: 'POST',
           data: 'delete='+wId,
           dataType: 'json'
        })
