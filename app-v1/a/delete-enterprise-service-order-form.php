...
if ($_POST['delete']) {
    ...
    $deleteQuery = "DELETE FROM ent_order_form WHERE id=$cId";
 ...
 $response['message'] = 'Enterprise Service Order Form Deleted Successfully.';
    } else {
        $response['status']  = 'error';
 $response['message'] = 'Unable to Delete Enterprise Order Form.';
    }
