      ...
      <div class="main-content">
        <section class="section">
          <h1 class="section-header">
            <div>Manage Change Oder for Internet Service Records
            <br>
          ...
          <div class="section-body">
            <div class="card">
              ...
              <?php manageInternetChangeOrderForm(); ?>
            </div>
...
<script type="text/javascript">
    ...
    <script>  
 $(document).ready(function(){  
      $('#change-order-form-data').DataTable();  
 });  
 </script>  
...
<script>
 $(document).ready(function(){
  ...
  $(document).on('click', '#delete_change_order_form', function(e){
  ...
  swal.fire({
   ...
   preConfirm: function() {
     return new Promise(function(resolve) {
        ...
        $.ajax({
        url: 'delete-change-order-form.php',
        type: 'POST',
           data: 'delete='+changeId,
           dataType: 'json'
        })
