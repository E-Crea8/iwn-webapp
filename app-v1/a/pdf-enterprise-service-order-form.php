...
<head>
  ...
  <!-- PDF JS SCRIPT -->
  <script src="../assets/PDF/enterpriseServiceOrderGenPDF.js"></script>
...
<body style="background-color: #FFFFFF !important;">
  <div id="app">
    <section class="section">
      ...
      <!-- Echo PHP Table Here -->
      <?php
        EnterpriseServiceOrderForm($form_id);
      ?>
    ...
    <div class="text-center" style="margin-bottom: 20px;">
        <button class="btn btn-dark" id="downloadEnterpriseOrderFormPDF">Download PDF</button>
      </div>
