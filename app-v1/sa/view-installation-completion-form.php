...
<head>
  ...
  <!-- PDF JS SCRIPT -->
  <script src="../assets/PDF/installationCompletionGenPDF.js"></script>
...
<body style="background-color: #FFFFFF !important;">
  <div id="app">
    <section class="section">
      ...
      <!-- Echo PHP Table Here -->
      <?php
        installationCompletionForm($form_id);
      ?>
    ...
    <div class="text-center" style="margin-bottom: 20px;">
        <button class="btn btn-dark" id="downloadInstallationCompletionFormPDF">Download PDF</button>
      </div>
