...
<head>
  ...
  <!-- PDF JS SCRIPT -->
  <script src="../assets/PDF/equipmentLeaseGenPDF.js"></script>
...
<body style="background-color: #FFFFFF !important;">
  <div id="app">
    ...
    <div class="text-center" style="margin-bottom: 20px;">
        <button class="btn btn-dark" id="downloadEquipmentLeaseFormPDF">Download PDF</button>
      </div>
