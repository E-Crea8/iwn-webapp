...
$insertUserActionHistory = "INSERT INTO app_history (email, action) VALUES ( '$getUserEmail', 'De-Activated User - $getUserFName $getUserLName')";
$doInsertUserHistory = mysqli_query($dbc, $insertUserActionHistory);

if($_REQUEST['userID']) {
$sql = "UPDATE users SET active_status = '0' WHERE user_id='".$_REQUEST['userID']."'";
