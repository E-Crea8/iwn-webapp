              ...
              <form method="post" class="needs-validation" novalidate="">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div style="font-weight: 500;">Internet Service Order Form - <div style="margin-top: 10px;"><span
                          style="background-color: #F7F7F7; padding: 10px; border-radius: 4px; padding: 8px; border: #F58634 1px solid; font-weight: normal;">
                          https://bit.ly/3bSXGWm </span></div>
                    </div>
                    <div style="font-weight: 500; margin-top: 20px;">Enterprise Internet Service Order Form - <div
                        style="margin-top: 10px;"><span
                          style="background-color: #F7F7F7; padding: 10px; border-radius: 4px; padding: 8px; border: #F58634 1px solid; font-weight: normal;">
                          https://bit.ly/3f7VdLf </span></div>
                    </div>
                    <div style="font-weight: 500; margin-top: 20px;">Internet Service Change Order Form - <div
                        style="margin-top: 10px;"><span
                          style="background-color: #F7F7F7; padding: 10px; border-radius: 4px; padding: 8px; border: #F58634 1px solid; font-weight: normal;">
                          https://bit.ly/2NJg9MR </span></div>
                    </div>
                    <div style="font-weight: 500; margin-top: 20px;">Equipment Lease Form - - <div
                        style="margin-top: 10px;"><span
                          style="background-color: #F7F7F7; padding: 10px; border-radius: 4px; padding: 8px; border: #F58634 1px solid; font-weight: normal;">
                          https://bit.ly/3bcHHUf </span></div>
                    </div>
                    <div style="font-weight: 500; margin-top: 20px;">Equipment Retrieval Form - <div
                        style="margin-top: 10px;"><span
                          style="background-color: #F7F7F7; padding: 10px; border-radius: 4px; padding: 8px; border: #F58634 1px solid; font-weight: normal;">
