...
<head>
    ...
    <title>IWN App - Manage Equipment Lease Record</title>
            ...
            <div class="main-content">
                <section class="section">
                    <h1 class="section-header">
                        <div>Manage Equipment Lease Records
                            <br>
                            <span style="font-size:11px; color:#FF0000;"> Note: Records are sorted from newest to
                                oldest</span>
                        </div>
                    </h1>
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        ...
                        .fail(function() {
                            swal.fire('Oops...', 'Something went wrong with delete process!',
                                'error');
                        });
                });
            },
