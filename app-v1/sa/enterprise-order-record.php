...
<head>
  ...
  <title>IWN App - Manage Enterprise Service Order Record</title>
      ...
      <div class="main-content">
        <section class="section">
          <h1 class="section-header">
            <div>Manage Enterprise Service Order Records
            <br>
          ...
          <div class="section-body">
            <div class="card">
              ...
              <?php manageEnterpriseServiceOrderForm(); ?>
            </div>
...
<script type="text/javascript">
    ...
    <script>  
 $(document).ready(function(){  
      $('#enterpriseOrderFormData').DataTable();  
 });  
 </script>  
...
<script>
 $(document).ready(function(){
  ...
  $(document).on('click', '#delete-enterprise-service-order-form', function(e){
   
   var entId = $(this).data('id');
   SwalDelete(entId);
   e.preventDefault();
  });
  ...
  swal.fire({
   ...
   preConfirm: function() {
     return new Promise(function(resolve) {
        ...
        $.ajax({
        url: 'delete-enterprise-service-order-form.php',
        type: 'POST',
           data: 'delete='+entId,
           dataType: 'json'
        })
