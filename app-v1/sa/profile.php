                ...
                <form name="update-user-profile" method="POST">
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input id="firstame" type="text" value="<?php echo $row['firstname']; ?>" class="form-control"
                        name="firstname" autofocus required>
                    </div>
                    <div class="form-group col-6">
                      <label for="lastname">Lastname</label>
                      <input class="form-control" id="lastname" value="<?php echo $row['lastname']; ?>" name="lastname"
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input id="email" type="email" class="form-control" value="<?php echo $row['email']; ?>"
                        name="email" autofocus required>
                    </div>
                    <div class="form-group col-6">
                      <label for="password">Password<span style="font-size: 8px;"> (You can set a new password
                          here)</span></label>
                      <input id="password" type="password" class="form-control"
                        value="<?php echo $row['normal_password']; ?>" name="password" autofocus required>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="form-group col-12">
                      ...
                      <input id="position" type="position" class="form-control" value="<?php echo $row['position']; ?>"
                        name="position" autofocus required readonly>
                    </div>
                  </div>
