...
<head>
  ...
  <title>IWN App - Manage Equipment Change Order Record</title>
      ...
      <div class="main-content">
        <section class="section">
          <h1 class="section-header">
            <div>Manage Equipment Change Order Records
            <br>
          ...
          <div class="section-body">
            <div class="card">
              ...
              <?php manageEquipmentChangeOrderForm(); ?>
            </div>
...
<script type="text/javascript">
    ...
    <script>  
 $(document).ready(function(){  
      $('#equipmentChangeOrderData').DataTable();  
 });  
 </script>  



<!-- Delete Equipment Change Order Record Sweet Alert -->
<script>
 $(document).ready(function(){
  
  // readOrderForms* it will load products when document loads */
  
  $(document).on('click', '#delete-equipment-change-order-form', function(e){
  ...
  swal.fire({
   ...
   preConfirm: function() {
     return new Promise(function(resolve) {
        ...
        $.ajax({
        url: 'delete-equipment-change-order-form.php',
        type: 'POST',
           data: 'delete='+ecId,
           dataType: 'json'
        })
