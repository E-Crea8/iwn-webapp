...
<head>
  ...
  <title>IWN App - Internet Service Order Form</title>
  ...
  <!-- PDF JS SCRIPT -->
  <script src="../assets/PDF/ipOrderGenPDF.js"></script>
...
<body style="background-color: #FFFFFF !important;">
  <div id="app">
    <section class="section">
      ...
      <!-- Echo PHP Table Here -->
      <?php
        InternetServiceOrderForm($form_id);
      ?>
    ...
    <div class="text-center" style="margin-bottom: 20px;">
        <button class="btn btn-dark" id="downloadIPOrderFormPDF">Download PDF</button>
      </div>
