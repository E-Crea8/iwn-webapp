...
function manageInternetServiceOrderForm(){
    global $dbc;
    $selectIPOrderFormData = "SELECT * FROM internet_service_order_form ORDER BY id DESC";
...
function InternetServiceOrderForm($form_id){
    global $dbc;
    $selectIPOrderFormRecord = "SELECT * FROM internet_service_order_form WHERE id = '$form_id'";
